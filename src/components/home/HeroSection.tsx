...
export default function HeroSection() {
  return (
    <section className="relative pt-40 pb-20 md:pt-48 md:pb-32 px-6 overflow-hidden w-full bg-white text-black rounded-b-[3rem] md:rounded-b-[5rem] relative z-20 transition-all duration-500">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto">
        ...
        >
          ...
          <span className="text-sm font-medium tracking-wide text-gray-600">New: Predictable Gym Growth System</span>
        </motion.div>
